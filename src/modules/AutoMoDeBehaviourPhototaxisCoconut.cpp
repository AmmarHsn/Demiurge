/**
  * @file <src/modules/AutoMoDeBehaviourPhototaxisCoconut.cpp>
  *
...
#include "AutoMoDeBehaviourPhototaxisCoconut.h"
...
namespace argos
{
	...
	AutoMoDeBehaviourPhototaxisCoconut::AutoMoDeBehaviourPhototaxisCoconut()
	{
	...
	AutoMoDeBehaviourPhototaxisCoconut::AutoMoDeBehaviourPhototaxisCoconut(AutoMoDeBehaviourPhototaxisCoconut *pc_behaviour)
	{
	...
	AutoMoDeBehaviourPhototaxisCoconut *AutoMoDeBehaviourPhototaxisCoconut::Clone()
	{
		return new AutoMoDeBehaviourPhototaxisCoconut(this);
	}

	/****************************************/
	/****************************************/

	void AutoMoDeBehaviourPhototaxisCoconut::ControlStep()
	{
	...
	void AutoMoDeBehaviourPhototaxisCoconut::Init()
	{
		bool error = false;
		m_walkSteps = 0;
	...
	void AutoMoDeBehaviourPhototaxisCoconut::Reset()
	{
	...
	void AutoMoDeBehaviourPhototaxisCoconut::ResumeStep()
	{
		m_bOperational = true;
	}
	...
	bool AutoMoDeBehaviourPhototaxisCoconut::Succeeded() {
		return false;
	}
	...
	bool AutoMoDeBehaviourPhototaxisCoconut::Failed() {
